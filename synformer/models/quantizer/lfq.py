...
class LFQ(Module):
    def __init__(
        ...
        *,
        ...
        self.maybe_l2norm = (lambda t: l2norm(t) * codebook_scale) if spherical else identity
        ...
        # whether to make the entropy loss positive through a softplus (experimental, please report if this worked or
        # not in discussions)
    ...
    def forward(
        ...
        quantization_context = cast(Callable, partial(autocast, enabled=False) if force_f32 else nullcontext)
        ...
        with quantization_context():
            ...
            if self.training:
                ...
                # 1. entropy will be nudged to be low for each code, to encourage the network to output confident
                #    predictions
                # 2. codebook entropy will be nudged to be high, to encourage all codes to be uniformly used within the
                #    batch
